...
if "BBOX" in param and "CHUNK_SIZE" in param: #and "AFF_MIP" in param:
    ...
    save_params_task = save_run_parameters_op(dag_manager, "param")
    ...
    wait["pp"] >> [save_params_task, scaling_igneous_finish, ending_op, stop_nfs_server]
